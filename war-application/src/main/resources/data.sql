DELETE FROM `shammy`.`user_authorities` ;
...
DELETE FROM `shammy`.`users` WHERE id = 3;
DELETE FROM `shammy`.`users` WHERE id = 4;
DELETE FROM `shammy`.`users` WHERE id = 5;
DELETE FROM `shammy`.`users` WHERE id = 6;
